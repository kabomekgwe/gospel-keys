"""
Chord Type Definitions and Library

Contains all chord type definitions (56 base chords) and core chord utility functions.
Part of the refactored chord theory system.
"""
